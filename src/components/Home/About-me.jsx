...
const AboutMe = () => {
    ...
    return (
        <section className="w-full py-16 md:py-20 bg-gray-50" id="about">
            <div className="mx-auto w-full max-w-7xl flex flex-col gap-12 px-4 md:px-8">
                {/* Title Centered */}
                <div className="flex justify-center">
                    <div className="flex items-center justify-center rounded-xl bg-gray-200 px-5 py-1">
                        <p className="text-sm font-medium">{t('about.section_title')}</p>
                    </div>
                </div>
                    ...
                    <div className="flex justify-center md:order-first md:justify-end">
                        <div className="relative h-[380px] w-[320px] md:h-[460px] md:w-[380px] lg:h-[520px] lg:w-[440px]">
                            <img
                                alt="Full pose"
                                loading="lazy"
                                className="absolute z-10 h-[360px] w-[280px] border-8 border-white max-md:left-5 md:right-0 md:top-0 md:h-[420px] md:w-[340px] lg:h-[480px] lg:w-[400px] object-cover"
                                src={t('about.image')}
                            />
